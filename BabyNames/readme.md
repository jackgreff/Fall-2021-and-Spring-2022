<h1 style="text-align: center;">Lab 3: Baby Names</h1>
...
format_):
  ...
  _Suggestion_: create different an ArrayList to hold the queried male names, another to hold the female ones and a
